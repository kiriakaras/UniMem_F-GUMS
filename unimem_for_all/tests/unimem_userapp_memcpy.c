...
/*		
                ...
                _mm256_stream_si256((__m256i*)dst+1, _mm256_stream_load_si256((__m256i*)src+1));
                _mm256_stream_si256((__m256i*)dst+2, _mm256_stream_load_si256((__m256i *)src+2));
                _mm256_stream_si256((__m256i*)dst+3, _mm256_stream_load_si256((__m256i*)src+3));
                _mm256_stream_si256((__m256i*)dst+4, _mm256_stream_load_si256((__m256i*)src+4));
                _mm256_stream_si256((__m256i*)dst+5, _mm256_stream_load_si256((__m256i*)src+5));
                _mm256_stream_si256((__m256i*)dst+6, _mm256_stream_load_si256((__m256i*)src+6));
                _mm256_stream_si256((__m256i*)dst+7, _mm256_stream_load_si256((__m256i *)src+7));
...
getchar();
   ...
   /*     if(size == 8){
            for(i=0;i<1;i++){
            copy_data_64(buffer, temparray, size);}
        }
        else if (size == 16)
            for (i=0;i<1;i++)
                copy_data_128(buffer, temparray,size);

        else if(size % 256 == 0)
                for (i=0;i<1;i++)
                    copy_data_2048(buffer, temparray,size);

        else if(size % 128 == 0)
                for (i=0;i<1;i++)
                    copy_data_1024(buffer, temparray,size);

        else if(size % 64 == 0)
                for (i=0;i<1;i++)
                    copy_data_512(buffer, temparray,size);

        else if(size % 32 == 0)
                for (i=0;i<1;i++)
                    copy_data_256(buffer, temparray,size);
  ...
  //      printf("Last buffer[%d] value after write is %d..\n", (size/4)-1,buffer[(size/4)-1]);
       ...
       /* if(size == 8){
            ...
            for (i=0;i<1;i++)
                ...
                for (i=0;i<1;i++)
                    copy_data_2048(temparray, buffer,size);

        else if(size % 128 == 0)
                for (i=0;i<1;i++)
                    copy_data_1024(temparray, buffer,size);

        else if(size % 64 == 0)
                for (i=0;i<1;i++)
                    copy_data_512(temparray, buffer,size);
